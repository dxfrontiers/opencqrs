            ...
            eventHandlerDefinitions.stream()
                    ...
                    .forEach((group, ehds) -> {
                        ...
                        for (int partition = 0;
                            ...
                            var eventHandlingProcessorBeanDefinition = BeanDefinitionBuilder.genericBeanDefinition(EventHandlingProcessor.class)
                                    ...
                                    .getBeanDefinition();
                            beanRegistry.registerBeanDefinition(processorBeanName, eventHandlingProcessorBeanDefinition);
